...
public class BufferPool {
    ...
    //当前的缓存页
    private HashMap<PageId,Page>pidPages;
    ...
    public  Page getPage(TransactionId tid, PageId pid, Permissions perm)
        ...
        // some code goes here
    	if(pidPages.containsKey(pid))//命中
    		return pidPages.get(pid);//返回页面
    	//没有命中，访问磁盘并缓存
    	else
    	{
    ...
    {
    	pidPages.put(pid,newpage);
    	//如果超过最大缓存页的数量
    	if(pidPages.size()>PAGE_SIZE)
    	{
